 ...
 */
final class Version20241024080249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , updated_at DATE DEFAULT NULL, priority VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, description CLOB NOT NULL, CONSTRAINT FK_97A0ADA3F4BD7827 FOREIGN KEY (assigned_to_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
